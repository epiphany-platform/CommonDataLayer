...
array=( data-router command-service query-router query-service query-service-ts schema-registry upload-to-kafka upload-to-rabbitmq api edge-registry object-builder )
