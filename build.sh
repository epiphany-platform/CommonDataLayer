...
# CDL_VERSION=0.1.0
# CDL_PUSH=true
array=( data-router command-service query-router query-service query-service-ts leader-elector schema-registry upload-to-kafka upload-to-rabbitmq api edge-registry partial-update-engine object-builder )
